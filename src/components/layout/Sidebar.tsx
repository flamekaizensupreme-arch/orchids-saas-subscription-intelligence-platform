...
const navItems = [
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, dataTour: "nav-dashboard" },
  { href: "/subscriptions", label: "Subscriptions", icon: CreditCard, dataTour: "nav-subscriptions" },
  { href: "/subscriptions/add", label: "Add New", icon: PlusCircle, dataTour: "nav-add" },
  { href: "/alerts", label: "Alerts", icon: Bell, badge: mockAlerts.filter(a => !a.isRead).length, dataTour: "nav-alerts" },
  { href: "/budget", label: "Budget", icon: PiggyBank, dataTour: "nav-budget" },
  { href: "/savings", label: "Savings", icon: Lightbulb, dataTour: "nav-savings" },
  { href: "/team", label: "Team", icon: Users, dataTour: "nav-team" },
  { href: "/settings", label: "Settings", icon: Settings, dataTour: "nav-settings" },
];
