...
export default function DashboardPage() {
  const { shouldRunTour, completeTour, restartTour } = useTour();
  ...
  return (
    <AppLayout title="Dashboard" subtitle="Your subscription overview">
      <ProductTour runTour={shouldRunTour} onComplete={completeTour} />
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="relative overflow-hidden" data-tour="monthly-spending">
          ...
          <Card className="relative overflow-hidden" data-tour="active-subscriptions">
          ...
          <Card className="relative overflow-hidden" data-tour="annual-projection">
          ...
          <Card className="relative overflow-hidden border-chart-3/30 bg-gradient-to-br from-chart-3/5 to-transparent" data-tour="potential-savings">
            <CardContent className="p-5">
              <div className="flex items-center justify-between mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-2" data-tour="spending-trend">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-gradient-to-br from-primary/5 via-chart-2/5 to-chart-3/5 border-primary/20" data-tour="savings-opportunities">
            <CardHeader className="pb-2 flex flex-row items-center justify-between">
